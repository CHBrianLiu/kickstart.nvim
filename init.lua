...
vim.opt.statusline = ''
-- have only one global status line
...
vim.keymap.set('n', 'k', 'gk', { desc = 'Move up one visual line.' })
...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>rr', vim.lsp.buf.code_action, 'Code Action ([R]efactoring)', { 'n', 'x' })
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      require('nord').setup { dim_inactive = { enabled = true } }
